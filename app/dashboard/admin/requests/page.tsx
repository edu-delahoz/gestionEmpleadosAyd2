...
export default function AdminRequestsPage() {
  ...
  const handleUpdateStatus = async (requestId: string, nextStatus: "APPROVED" | "REJECTED") => {
    ...
    try {
      ...
      toast.success(`Solicitud ${nextStatus === "APPROVED" ? "aprobada" : "rechazada"}`)
      refresh()
    } catch (error) {
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-3xl font-bold text-foreground">Solicitudes globales</h1>
            <p className="text-muted-foreground">Visibilidad completa para administración</p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Refina la información para tomar decisiones</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Listado completo para seguimiento administrativo</CardDescription>
          </CardHeader>
